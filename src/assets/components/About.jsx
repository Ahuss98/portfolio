...
function About(){
    ...
    const goToProjects = () => {
        ...
        const toggleAbout = (info) =>{
            ...
            if(info === 'PI'){
                setAbout([{img:"images/PI-logo.png",h3:'Personal Info',p:'A Career changer from a personal Trainer and Amutuer fighter I love to solve problems and take on challenges currently chasing my Black Belt as a software developer.'}])
            }
            setSelectedBtn(info);
        }
